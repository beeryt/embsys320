...
*
*              (2) All tasks run in Thread mode, using main stack.
*
...
*                                          SYS TICK INIT
*
* Description: Initializes the hardware for the timer tick to be used by uCOS
*
* Arguments  : ticksPerSec is the number of ticks per second
*
